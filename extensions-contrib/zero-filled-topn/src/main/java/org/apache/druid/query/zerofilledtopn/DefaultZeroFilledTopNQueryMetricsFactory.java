...
public class DefaultZeroFilledTopNQueryMetricsFactory implements ZeroFilledTopNQueryMetricsFactory
{
  ...
  private static final ZeroFilledTopNQueryMetricsFactory INSTANCE = new DefaultZeroFilledTopNQueryMetricsFactory();
  ...
  {
    return new DefaultZeroFilledTopNQueryMetrics();
  }
