...
public class ZeroFilledTopNQueryQueryToolChest extends QueryToolChest<Result<TopNResultValue>, ZeroFilledTopNQuery> {
    ...
    public ZeroFilledTopNQueryQueryToolChest(
        ...
        this(config, intervalChunkingQueryRunnerDecorator, DefaultZeroFilledTopNQueryMetricsFactory.instance());
    }
        ...
        return intervalChunkingQueryRunnerDecorator.decorate(
                new QueryRunner<Result<TopNResultValue>>() {
                    ...
                    public Sequence<Result<TopNResultValue>> run(
                        ...
                        if (zeroFilledTopNQuery.getDimensionsFilter() != null) {
                            zeroFilledTopNQuery = zeroFilledTopNQuery.withDimFilter(zeroFilledTopNQuery.getDimensionsFilter().optimize());
                        }
                        final ZeroFilledTopNQuery delegateTopNQuery = zeroFilledTopNQuery;
                        if (TopNQueryEngine.canApplyExtractionInPost(delegateTopNQuery.toTopNQuery())) {
